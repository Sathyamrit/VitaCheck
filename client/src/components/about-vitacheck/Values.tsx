    ...
    <section className="py-12 border-t border-gray-100">
      ...
      <div className="grid sm:grid-cols-3 gap-12">
        <div className="text-center">
          ...
          <p className="text-gray-500 text-sm">We use HIPAA-compliant infrastructure and encryption to ensure your health data remains yours alone.[5, 6]</p>
        </div>
        <div className="text-center">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-500 text-sm">We don't just identify gaps; we provide customized recipes optimized for bioavailability.[7, 8]</p>
        </div>
      </div>
    </section>
  );
